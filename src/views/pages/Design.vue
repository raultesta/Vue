...
export default {
  ...
  data: () => ({
    hexagons: [
      '/src/assets/images/Hex/svg/Hexagons_RT_logo-01.svg',
      '/src/assets/images/Hex/svg/Hexagons_RT_logo-02.svg',
      '/src/assets/images/Hex/svg/Hexagons_RT_logo-03.svg',
      '/src/assets/images/Hex/svg/Hexagons_RT_logo-04.svg',
      '/src/assets/images/Hex/svg/Hexagons_RT_logo-05.svg',
      '/src/assets/images/Hex/svg/Hexagons_RT_logo-06.svg',
      '/src/assets/images/Hex/svg/Hexagons_RT_logo-07.svg',
      '/src/assets/images/Hex/svg/Hexagons_RT_logo-08.svg',
      '/src/assets/images/Hex/svg/Hexagons_RT_logo-09.svg',
      '/src/assets/images/Hex/svg/Hexagons_RT_logo-10.svg',
      '/src/assets/images/Hex/svg/Hexagons_RT_logo-11.svg',
      '/src/assets/images/Hex/svg/Hexagons_RT_logo-12.svg',
      '/src/assets/images/Hex/svg/Hexagons_RT_logo-13.svg',
      '/src/assets/images/Hex/svg/Hexagons_RT_logo-14.svg',
